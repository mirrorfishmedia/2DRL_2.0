...
public class ExplodePosition : MonoBehaviour {
    ...
    void DamageWalls(int index)
    {
...

        {
            ...
            roundedGrid.x = Mathf.Clamp(roundedGrid.x, 0, boardGenerator.profile.boardHorizontalSize - 1);
            roundedGrid.y = Mathf.Clamp(roundedGrid.y, 0, boardGenerator.profile.boardVerticalSize - 1);
